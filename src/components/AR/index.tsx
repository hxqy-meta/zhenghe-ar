...
const AR = () => {
    ...
    return (
        <a-scene 
            mindar-image="maxTrack: 2; warmupTolerance: 1; filterMinCF:0.1; filterBeta: 10; imageTargetSrc: assets/zhenghe/zhenghe.mind;" 
            color-space="sRGB" 
        ...
        >
            ...
            <a-entity mindar-image-target="targetIndex: 0">
                <a-plane src="#zhenghe1" position="0 0 0" height="1" width="1" rotation="0 0 0"></a-plane> 
                <a-gltf-model rotation="0 0 0" position="0 0 0" scale="10 10 10" src="#warrior1" animation="property: position; to: 0 0.1 0.1; dur: 1000; easing: easeInOutQuad; loop: true; dir: alternate" />
            </a-entity>
            <a-entity mindar-image-target="targetIndex: 1">
                <a-plane src="#zhenghe2" position="0 0 0" height="1" width="1" rotation="0 0 0"></a-plane> 
