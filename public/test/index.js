...
function setupObjects(longitude, latitude) {
    ...
    threex.add(new THREE.Mesh(geom, material), longitude, latitude + 0.00001); // slightly north
    threex.add(new THREE.Mesh(geom, material2), longitude, latitude - 0.00001); // slightly south
    threex.add(new THREE.Mesh(geom, material3), longitude - 0.00001, latitude); // slightly west
    threex.add(new THREE.Mesh(geom, material4), longitude + 0.00001, latitude); // slightly east
}
